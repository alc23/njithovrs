...
public class RollTraceBallData : MonoBehaviour {
	...
	static float timer;
	public static string fileName = string.Format("TestingHandROllAccuracyData" + DateTime.Today.ToString("MMddyyyy") + ".txt");
