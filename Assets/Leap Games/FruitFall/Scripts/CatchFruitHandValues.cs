...
//
//
//public class CatchFruitHandValues : MonoBehaviour {
//	
...
//	
//	
//	public static string fileName = string.Format("CatchFruitHandData" + DateTime.Today.ToString("MMddyyyy") + ".txt");
//	
...
//
//				sw.Write ("," + ScaleBasketMovement.xmin);
//				sw.Write ("," + ScaleBasketMovement.xmax);
//				sw.Write ("," + RollCalibration1.roll);
//				sw.Write ("," + ScaleBasketMovement.originscaled);
//				sw.Write ("," + ScaleBasketMovement.thresholdscaled);
//				sw.Write ("," + ScaleBasketMovement.scaled);
//
//			}
//			
//			sw.Write ("\n");
