...
public class PlayMovSoccer: MonoBehaviour {
	...
	void Update(){
		...
		Debug.Log (ScaleSoccer.success);

		//hand is missing
		if (HandValuesSoccer.invalidhands == true) {
			chosen = 1;
		}
		...
		if (ScaleSoccer.success  > 20 && ScaleSoccer.success < 22) {
			chosen = 3;
		}
