...
//
//public class CatchFruitPlayMov: MonoBehaviour {
//	
...
//		
//		//hand is missing
//		if (CatchFruitHandValues.invalidhands == true) {
//			chosen = 1;
//		}
//		
//		//hand is returned
//		if (CatchFruitHandValues.invalidhands == false) {
//			chosen = 2;
//		}
//
//		//when a strike is scored
//		if (FruitScoreCount.x  > 10 && FruitScoreCount.x < 15) {
//			chosen = 3;
//		}
//
//		if (ScaleBasketMovement.algpercentage == true) {
//			chosen = 4;
//		}
//
//
