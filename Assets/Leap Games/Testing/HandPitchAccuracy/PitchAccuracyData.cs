...
public class PitchAccuracyData : MonoBehaviour {
	...
	static float timer;
	public static string fileName = string.Format("TestingHandPitchAccuracyData" + DateTime.Today.ToString("MMddyyyy") + ".txt");
