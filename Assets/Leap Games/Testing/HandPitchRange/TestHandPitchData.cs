...
public class TestHandPitchData : MonoBehaviour {
	...
	static float timer;
	public static string fileName = string.Format("TestingHandPitchRangeData" + DateTime.Today.ToString("MMddyyyy") + ".txt");
