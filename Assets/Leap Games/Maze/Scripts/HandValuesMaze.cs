...
public class HandValuesMaze : MonoBehaviour {
	...
	public static string fileName = string.Format("HandMazeData" + DateTime.Today.ToString("MMddyyyy") + ".txt");
	StreamWriter sw = new StreamWriter ("Data/Maze/" + fileName, true);
	...
	void Update (){
		...
		foreach (Hand hand in frame.Hands) {
			...
			foreach (Finger finger in hand.Fingers) {
				...
				//score count
				sw.Write ("," + MazeScore.mazeScore);
				//speed of character
				sw.Write ("," + MoveBall.mazeSliderValue2);
			}
